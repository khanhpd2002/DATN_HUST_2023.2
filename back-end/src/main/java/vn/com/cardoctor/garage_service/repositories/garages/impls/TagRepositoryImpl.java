...
import vn.com.cardoctor.garage_service.repositories.garages.TagRepositoryCustom;
...
public class TagRepositoryImpl implements TagRepositoryCustom {
    ...
    public PagingDataResponse findAllTag(String name, String description, Integer status,
        ...
        jpql.append("select * from tags t ");
        ...
        jpql.append(" order by t.created_at desc limit :limit offset :offset ");
        ...
        Query q = entityManager.createNativeQuery(jpql.toString(), Tag.class);
