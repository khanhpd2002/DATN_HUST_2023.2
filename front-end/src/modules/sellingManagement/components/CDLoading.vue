<template>
    ...
    >
        ...
        <p v-if="showLabel" class="text-gray-800 dark:text-gray-300 mt-2">
            {{ label }}
        </p>
    </div>
</template>
...
import { LoadingSpinnerColor, LoadingSpinnerSize } from "./constants";
...
const { color, label, showLabel } = toRefs(props);
