					...
					<div class="invoice-container">
						...
						>
							<div class="WordSection1">
								...
								<p class="mt-[20px]" style="text-align: center">
									<b
										><span
											style="
												font-size: 14pt;
											...
											"
											>{{
												$t('module.sharedModules.print.quotation.title1')
											}}</span
										></b
									>
								</p>
